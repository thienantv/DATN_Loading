...
router.get('/categories', authorize(['STOREKEEPER', 'MANAGER', 'OWNER']), inventoryController.getInventoryCategories)
...
router.get('/products', authorize(['STOREKEEPER', 'MANAGER', 'WORKER', 'OWNER']), inventoryController.getProducts)
router.get('/products/:productId', authorize(['STOREKEEPER', 'MANAGER', 'WORKER', 'OWNER']), inventoryController.getProductById)
...
router.get('/balance', authorize(['STOREKEEPER', 'MANAGER', 'OWNER']), inventoryController.getInventoryBalance)
router.get('/summary', authorize(['STOREKEEPER', 'MANAGER', 'OWNER']), inventoryController.getInventorySummary)
